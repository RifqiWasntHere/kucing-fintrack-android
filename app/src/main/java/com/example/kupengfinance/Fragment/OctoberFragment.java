...
public class OctoberFragment extends Fragment {
    ...
    public static OctoberFragment getInstance() {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        buildListDataOctober(view);
//        initRecycleView(view);
    }

    private void buildListDataOctober(View view) {
        ...
        call.enqueue(new Callback<List<Transaction_Model>>() {
            ...
            public void onResponse(Call<List<Transaction_Model>> call, Response<List<Transaction_Model>> response) {
                ...
                RecyclerView recyclerView = view.findViewById(R.id.viewOctober);
